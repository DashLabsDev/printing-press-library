...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/health/carol-bike/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CAROL_BIKE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "carol-bike-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
