...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/wanderlog/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "wanderlog-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
