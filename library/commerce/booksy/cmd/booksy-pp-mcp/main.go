...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/commerce/booksy/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/booksy/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("BOOKSY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "booksy-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
