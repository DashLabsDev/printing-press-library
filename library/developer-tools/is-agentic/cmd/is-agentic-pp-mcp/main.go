...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/is-agentic/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/is-agentic/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("IS_AGENTIC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "is-agentic-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
