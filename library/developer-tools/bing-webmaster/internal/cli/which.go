...
var whichIndex = []whichEntry{
	...
	{Command: "publish", Description: "Submit many URLs (or a whole sitemap) for indexing, automatically chunked to the 500-per-request cap, paced against your live remaining quota, and deduped against URLs already submitted.", Group: "Submission at scale", WhyItMatters: "Pick this over raw SubmitUrlBatch whenever submitting more than a handful of URLs; it won't blow the daily quota or resubmit."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bing-webmaster-pp-cli which "stale tickets"
  bing-webmaster-pp-cli which "bottleneck"
  bing-webmaster-pp-cli which --limit 1 "send message"
  bing-webmaster-pp-cli which                                # list the full capability index`,
