...
Exit codes & warnings:
  ...
  bing-webmaster-pp-cli sync

  # Sync specific resources only
  bing-webmaster-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  bing-webmaster-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  bing-webmaster-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  bing-webmaster-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  bing-webmaster-pp-cli sync --latest-only`,
