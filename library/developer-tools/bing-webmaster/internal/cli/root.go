...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("bing-webmaster-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'bing-webmaster-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDeeplinksCmd(flags))
	...
	rootCmd.AddCommand(newParamsCmd(flags))
	...
	// Transcendence commands (hand-built SEO intelligence on the local snapshot store).
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("bing-webmaster-pp-cli %s\n", version)
		},
	}
}
