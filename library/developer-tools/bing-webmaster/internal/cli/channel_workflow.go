...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  bing-webmaster-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  bing-webmaster-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  bing-webmaster-pp-cli workflow status

  # Show status as JSON
  bing-webmaster-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("bing-webmaster-pp-cli")
			}
