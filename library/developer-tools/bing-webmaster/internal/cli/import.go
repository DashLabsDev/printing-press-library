...
but do not stop the import.`,
  ...
  bing-webmaster-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bing-webmaster-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bing-webmaster-pp-cli import <resource> --input -`,
