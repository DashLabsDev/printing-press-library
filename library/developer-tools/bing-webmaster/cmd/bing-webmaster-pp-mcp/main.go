...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/bing-webmaster/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "bing-webmaster-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
