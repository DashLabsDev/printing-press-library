...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/project-management/plane/internal/learn"
...
type rootFlags struct {
	...
	// invocation. Mirrors the PLANE_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "plane-pp-cli",
		Short: `Plane CLI — Every Plane workspace as a typed, offline-syncable CLI — plus issue relations and module membership the REST API hides.`,
		Long: `Plane CLI — Every Plane workspace as a typed, offline-syncable CLI — plus issue relations and module membership the REST API hides.
...
Health check: run 'plane-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelModuleCmd(flags))
	rootCmd.AddCommand(newNovelRelationsCmd(flags))
