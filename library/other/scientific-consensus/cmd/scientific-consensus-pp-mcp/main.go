...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/scientific-consensus/internal/mcp"
)
...
var version = "2026.8.12"

func main() {
	s := server.NewMCPServer(
		"Scientific Consensus Via",
		version,
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "scientific-consensus-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
