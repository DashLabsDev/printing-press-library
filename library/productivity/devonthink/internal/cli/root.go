...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "devonthink-pp-cli",
		Short: `Devonthink CLI — Local-first DEVONthink automation with safer shell workflows than raw AppleScript or MCP alone.`,
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("devonthink-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'devonthink-pp-cli profile list')")
	...
	rootCmd.AddCommand(newIngestCmd(flags))
	...
	rootCmd.AddCommand(newRecordsCmd(flags))
	rootCmd.AddCommand(newSelectionCmd(flags))
	...
	rootCmd.AddCommand(newContextPromotedCmd(flags))
	rootCmd.AddCommand(newDatabasesPromotedCmd(flags))
	rootCmd.AddCommand(newGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newInventoryPromotedCmd(flags))
	rootCmd.AddCommand(newPrivacyPromotedCmd(flags))
	rootCmd.AddCommand(newRuntimePromotedCmd(flags))
	rootCmd.AddCommand(newSheetsPromotedCmd(flags))
