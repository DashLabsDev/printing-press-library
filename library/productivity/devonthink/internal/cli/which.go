...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  devonthink-pp-cli which "stale tickets"
  devonthink-pp-cli which "bottleneck"
  devonthink-pp-cli which --limit 1 "send message"
  devonthink-pp-cli which                                # list the full capability index`,
