...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/devonthink/internal/cliutil"
...
native streaming instead of polling.`,
  ...
  devonthink-pp-cli tail --interval 10s

  # Tail a specific resource
  devonthink-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  devonthink-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
