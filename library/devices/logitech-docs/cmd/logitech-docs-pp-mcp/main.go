...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/logitech-docs/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/logitech-docs/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("LOGITECH_DOCS_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "logitech-docs-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
