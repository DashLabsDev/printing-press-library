...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/crestron/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("CRESTRON_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "crestron-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
