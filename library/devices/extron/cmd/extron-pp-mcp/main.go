...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/extron/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/extron/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("EXTRON_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "extron-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
